...
namespace Zen.MachineLearning.Core.Neural
{
    ...
    public class ActivationNeuron : Neuron
    {
        ...
        /// </remarks>
        public IActivationFunction ActivationFunction { get; set; } = null;
        ...
        public override void Randomize()
        {
            ...
            // randomize threshold
            Threshold = RandomFactory.NextDouble() * randRange.Length + randRange.Min;
        }
        ...
        public override double Compute(double[] input)
        {
            ...
            // initial sum value
            var sum = _weights
                .Select((weight, i) => weight * input[i])
                .Sum();
